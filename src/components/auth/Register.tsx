    ...
    return (
        <div className="w-full max-w-md mx-auto mt-20">
            ...
            <div className="text-center mt-4 text-md">
                <span className="text-gray-600 dark:text-gray-300">Has an account? </span>
                <Link to="/login" className="font-semibold text-blue-600 dark:text-[#1A9FFF] hover:underline">
                    Sign in
                </Link>
            </div>
        </div>
